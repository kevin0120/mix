...
func NewHistogramAggregator() rush.Aggregator {
...
func (h *HistogramAggregator) Add(in rush.Metric) {
...
func (h *HistogramAggregator) Push(acc rush.Accumulator) {
...
func init() {
	aggregators.Add("histogram", func() rush.Aggregator {
