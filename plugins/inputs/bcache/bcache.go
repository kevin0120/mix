...
var sampleConfig = `
  ...
  ## By default, rush gather stats for all bcache devices
...
func (b *Bcache) gatherBcache(bdev string, acc rush.Accumulator) error {
	tags := getTags(bdev)
...
func (b *Bcache) Gather(acc rush.Accumulator) error {
...
func init() {
	inputs.Add("bcache", func() rush.Input {
		return &Bcache{}
	})
}
