...
func (n *NTPQ) Gather(acc rush.Accumulator) error {
	out, err := n.runQ()
	if err != nil {
		return err
	}
	...
	// see: https://github.com/masami10/rush/issues/2386
	...
	for scanner.Scan() {
		...
		// see https://github.com/masami10/rush/issues/1161
...
func init() {
	inputs.Add("ntpq", func() rush.Input {
		n := &NTPQ{}
		n.runQ = n.runq
		return n
	})
