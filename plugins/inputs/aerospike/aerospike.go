...
func (a *Aerospike) Gather(acc rush.Accumulator) error {
	if len(a.Servers) == 0 {
...
func (a *Aerospike) gatherServer(hostport string, acc rush.Accumulator) error {
...
func init() {
	inputs.Add("aerospike", func() rush.Input {
		return &Aerospike{}
	})
}
