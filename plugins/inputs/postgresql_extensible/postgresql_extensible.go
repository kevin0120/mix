...
import (
	...
	"github.com/masami10/rush/plugins/inputs/postgresql"
)
...
func (p *Postgresql) accRow(meas_name string, row scanner, acc rush.Accumulator) error {
	var (
		err        error
...
func init() {
	inputs.Add("postgresql_extensible", func() rush.Input {
		return &Postgresql{}
	})
}
