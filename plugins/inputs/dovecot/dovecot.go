...
func (d *Dovecot) Gather(acc rush.Accumulator) error {
...
func (d *Dovecot) gatherServer(addr string, acc rush.Accumulator, qtype string, filter string) error {
...
func gatherStats(buf *bytes.Buffer, acc rush.Accumulator, host string, qtype string) error {
...
func init() {
	inputs.Add("dovecot", func() rush.Input {
		return &Dovecot{}
	})
}
