...
func (s *Server) gatherData(acc rush.Accumulator) error {
...
func (s *Server) addClusterStats(acc rush.Accumulator) error {
...
func (s *Server) addMemberStats(acc rush.Accumulator) error {
...
func (s *Server) addTableStats(acc rush.Accumulator) error {
