...
Different platforms gather the data above with different mechanisms. Rush uses the ([gopsutil](https://github.com/shirou/gopsutil)) package, which under Linux reads the /proc/net/dev file.
...
```
# All platforms
$ ./rush --config rush.conf --input-filter net --test
