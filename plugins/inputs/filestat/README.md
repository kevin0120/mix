...
[[inputs.filestat]]
  ...
  files = ["/etc/rush/rush.conf", "/var/log/**.log"]
...
```
$ rush --config /etc/rush/rush.conf --input-filter filestat --test
* Plugin: filestat, Collection 1
> filestat,file=/tmp/foo/bar,host=tyrion exists=0i 1507218518192154351
> filestat,file=/Users/sparrc/ws/rush.conf,host=tyrion exists=1i,size=47894i,modification_time=1507152973123456789i  1507218518192154351
```
