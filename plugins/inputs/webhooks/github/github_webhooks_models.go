...
func (s CommitCommentEvent) NewMetric() rush.Metric {
...
func (s CreateEvent) NewMetric() rush.Metric {
	event := "create"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s DeleteEvent) NewMetric() rush.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s DeploymentEvent) NewMetric() rush.Metric {
	event := "deployment"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s DeploymentStatusEvent) NewMetric() rush.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s ForkEvent) NewMetric() rush.Metric {
	event := "fork"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s GollumEvent) NewMetric() rush.Metric {
	event := "gollum"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s IssueCommentEvent) NewMetric() rush.Metric {
	event := "issue_comment"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s IssuesEvent) NewMetric() rush.Metric {
	event := "issue"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s MemberEvent) NewMetric() rush.Metric {
	event := "member"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s MembershipEvent) NewMetric() rush.Metric {
	event := "membership"
	t := map[string]string{
		"event":  event,
		"user":   s.Sender.User,
...
func (s PageBuildEvent) NewMetric() rush.Metric {
	event := "page_build"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s PublicEvent) NewMetric() rush.Metric {
	event := "public"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s PullRequestEvent) NewMetric() rush.Metric {
	event := "pull_request"
	t := map[string]string{
		"event":      event,
		"action":     s.Action,
...
func (s PullRequestReviewCommentEvent) NewMetric() rush.Metric {
...
func (s PushEvent) NewMetric() rush.Metric {
	event := "push"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s ReleaseEvent) NewMetric() rush.Metric {
	event := "release"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s RepositoryEvent) NewMetric() rush.Metric {
	event := "repository"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s StatusEvent) NewMetric() rush.Metric {
	event := "status"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s TeamAddEvent) NewMetric() rush.Metric {
	event := "team_add"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s WatchEvent) NewMetric() rush.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
