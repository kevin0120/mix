...
func (c *Cassandra) Gather(acc rush.Accumulator) error {
	context := c.Context
	servers := c.Servers
	metrics := c.Metrics
...
func init() {
	inputs.Add("cassandra", func() rush.Input {
