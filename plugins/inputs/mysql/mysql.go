...
func (m *Mysql) Gather(acc rush.Accumulator) error {
	if len(m.Servers) == 0 {
...
func (m *Mysql) gatherServer(serv string, acc rush.Accumulator) error {
...
// MySQL environment.
func (m *Mysql) gatherGlobalVariables(db *sql.DB, serv string, acc rush.Accumulator) error {
	// run query
...
func (m *Mysql) gatherSlaveStatuses(db *sql.DB, serv string, acc rush.Accumulator) error {
	// run query
...
func (m *Mysql) gatherBinaryLogs(db *sql.DB, serv string, acc rush.Accumulator) error {
	// run query
...
func (m *Mysql) gatherGlobalStatuses(db *sql.DB, serv string, acc rush.Accumulator) error {
...
func (m *Mysql) GatherProcessListStatuses(db *sql.DB, serv string, acc rush.Accumulator) error {
	// run query
...
// and its state with its running count
func (m *Mysql) GatherUserStatisticsStatuses(db *sql.DB, serv string, acc rush.Accumulator) error {
	// run query
...
func (m *Mysql) gatherPerfTableIOWaits(db *sql.DB, serv string, acc rush.Accumulator) error {
...
func (m *Mysql) gatherPerfIndexIOWaits(db *sql.DB, serv string, acc rush.Accumulator) error {
...
func (m *Mysql) gatherInfoSchemaAutoIncStatuses(db *sql.DB, serv string, acc rush.Accumulator) error {
...
func (m *Mysql) gatherInnoDBMetrics(db *sql.DB, serv string, acc rush.Accumulator) error {
	// run query
...
func (m *Mysql) gatherPerfTableLockWaits(db *sql.DB, serv string, acc rush.Accumulator) error {
...
func (m *Mysql) gatherPerfEventWaits(db *sql.DB, serv string, acc rush.Accumulator) error {
...
func (m *Mysql) gatherPerfFileEventsStatuses(db *sql.DB, serv string, acc rush.Accumulator) error {
...
func (m *Mysql) gatherPerfEventsStatements(db *sql.DB, serv string, acc rush.Accumulator) error {
	query := fmt.Sprintf(
		perfEventsStatementsQuery,
...
func (m *Mysql) gatherTableSchema(db *sql.DB, serv string, acc rush.Accumulator) error {
	var dbList []string
	servtag := getDSNTag(serv)
...
func init() {
	inputs.Add("mysql", func() rush.Input {
		return &Mysql{}
	})
}
