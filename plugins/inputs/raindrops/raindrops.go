...
func (r *Raindrops) Gather(acc rush.Accumulator) error {
...
func (r *Raindrops) gatherUrl(addr *url.URL, acc rush.Accumulator) error {
...
func init() {
	inputs.Add("raindrops", func() rush.Input {
