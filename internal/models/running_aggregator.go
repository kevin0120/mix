...
func NewRunningAggregator(
	...
	return &RunningAggregator{
		a:       a,
		Config:  conf,
		metrics: make(chan rush.Metric, 100),
	}
}
...
func (r *RunningAggregator) Add(in rush.Metric) bool {
...
func (r *RunningAggregator) add(in rush.Metric) {
	r.a.Add(in)
}

func (r *RunningAggregator) push(acc rush.Accumulator) {
	r.a.Push(acc)
}
