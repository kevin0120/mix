...
class LoginPage extends React.Component {
  ...
  handlePress = (press) => {
    ...
    if (lodash.isEqual(press, '{enter}') && allInput.firstname.length !== 0 && allInput.password.length !== 0){
      this.handleSubmit();
    }
                  ...
                  <form>
                    <Card login className={classes[cardAnimaton]}>
                      ...
                      <CardFooter className={classes.justifyContentCenter}>
                        <Button disabled={disabled} color="rose" size="lg" round onClick={this.handleSubmit} ><Fingerprint />
                          {t('Login.Submit')}
                        </Button>
                      </CardFooter>
                    </Card>
