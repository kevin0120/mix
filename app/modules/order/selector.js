...
export const workingOrder = (orderState: tOrderState): ?Order =>
  orderState?.workingOrder;
export const viewingOrder = (orderState: tOrderState): ?Order =>
...
export const workingIndex = (order: ?Order): tOrderStepIdx =>
...
export const orderLength = (order: ?Order): number =>
...
export const isCancel = (order: ?Order): boolean =>
