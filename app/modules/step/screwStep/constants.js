...
export const SCREW_STEP = Object.freeze({
  ...
  BYPASS_SPEC_POINT: 'SCREW_STEP_BYPASS_SPEC_POINT',
  SELECT_TOOL: 'SCREW_STEP_SELECT_TOOL',
  SELECT_PSET: 'SCREW_STEP_SELECT_PSET',
  MANUAL: 'SCREW_STEP_MANUAL',
  BYPASS_RETRY: 'SCREW_STEP_BYPASS_RETRY'
});
