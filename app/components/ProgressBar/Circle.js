...
export default class Circle extends React.Component {
  ...
  render() {
    const { text, progress, size, bgColor,lineWidth, animate, animationDuration, roundedStroke, responsive, onAnimationEnd, textStyle, textColor } = this.props;
    ...
    return (
      <svg width={svgSize} height={svgSize} viewBox={`${-(viewSize/2-radius)} ${-(viewSize/2-radius)} ${viewSize} ${viewSize}`}>
