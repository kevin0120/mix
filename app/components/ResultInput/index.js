...
import { newData,manualCancel,manualTightening,start,close,didMount,clearStories,resultInput} from '../../modules/manual/action';
...
class ConnectedWorking extends React.Component {
  ...
  componentWillUnmount(): void {
    ...
    if (isNaN(a1) || a2===NaN || a1 <= 0 || a2 < 0 || this.v1.ok === ''){
      this.r.sucess=false
    }else {
      this.r.sucess=true
    }
          ...
          <Grid container spacing={0} className={classes.root} justify="center">
            ...
            <Grid item xs={9} style={{ height: '30%' }}>
              ...
              >
                ...
                <RadioGroup aria-label="gender" name="gender1" className={classes.cardDescription}  onChange={event => {this.v1.ok=event.target.value}}>
