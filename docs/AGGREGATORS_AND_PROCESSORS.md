# Rush Aggregator & Processor Plugins

As of release 1.1.0, Rush has the concept of Aggregator and Processor Plugins.

These plugins sit in-between Input & Output plugins, aggregating and processing
metrics as they pass through Rush:
...
Both Aggregators and Processors analyze metrics as they pass through Rush.
...
gathered, there is also a `drop_original` argument, which tells Rush to only
...
that you need, please comment on this [github issue](https://github.com/masami10/rush/issues/1992)
