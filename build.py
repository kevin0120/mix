...
SYSTEMD_SCRIPT = "scripts/aiis.service"
POSTINST_SCRIPT = "scripts/post-install.sh"
POSTUNINST_SCRIPT = "scripts/post-uninstall.sh"
LOGROTATE_CONFIG = "etc/logrotate.d/aiis"
BASH_COMPLETION_SH = "usr/share/bash-completion/completions/aiis"
DEFAULT_CONFIG = "etc/aiis/aiis.yaml"
DEFAULT_PMON_CONF = "etc/pmon/PMON.CFG"
PREINST_SCRIPT = None

# Default AWS S3 bucket for uploads
DEFAULT_BUCKET = "dl.influxdata.com/aiis/artifacts"

# META-PACKAGE VARIABLES
PACKAGE_LICENSE = "MIT"
PACKAGE_URL = "github.com/influxdata/aiis"
...
def create_package_fs(build_root):
    ...
    os.makedirs(os.path.join(build_root, os.path.dirname(DEFAULT_PMON_CONF)))
...
def package_scripts(build_root, config_only=False):
    ...
    if config_only:
        ...
        api_name = os.path.basename(DEFAULT_PMON_CONF)
        shutil.copyfile(DEFAULT_PMON_CONF, os.path.join(build_root, api_name))
        ...
        shutil.copy(DEFAULT_PMON_CONF, os.path.join(build_root, DEFAULT_PMON_CONF))
...
################
#### All Aiis-specific content above this line
################
