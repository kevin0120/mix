...
import (
	"flag"
	"fmt"
	"github.com/masami10/rush/cmd/rushd/help"
...
// Command represents the command executed by "rushd version".
...
func (cmd *VersionCommand) Run(args ...string) error {
	...
	// Print version info.
	fmt.Fprintf(cmd.Stdout, "Rush OSS version %s (git: %s %s)\n", version, branch, commit)
...
var versionUsage = `
usage: version
	version displays the Rush version, build branch and git commit hash
`
